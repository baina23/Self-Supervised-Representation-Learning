...
#                 doo1 = self.transform(img0.copy())
#                 doo2 = rotate_img(img0.copy(),  90)
#                 #print(img0.shape)
#                 print(doo2.shape)
#                 print('-------------pass 0--------------')
#                 #print(rotate_img(img0.copy(),  90))
#                 print(self.transform(rotate_img(img0.copy(),  90)))
#                 print('-------------pass 90--------------')
#                 print(self.transform(rotate_img(img0.copy(),  180)))
#                 print('-------------pass 180--------------')
#                 print(self.transform(rotate_img(img0.copy(),  270)))
#                 print('-------------pass 270--------------')


                rotated_imgs = [
                    self.transform(img0.copy()),
                    self.transform(rotate_img(img0.copy(),  90)),
                    self.transform(rotate_img(img0.copy(), 180)),
                    self.transform(rotate_img(img0.copy(), 270))
                ]
